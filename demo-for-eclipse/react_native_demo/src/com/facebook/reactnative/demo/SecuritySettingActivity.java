...
public class SecuritySettingActivity extends Activity implements DefaultHardwareBackBtnHandler {
...
//        .setBundleAssetName("SecuritySetting.android.bundle")
    ...
    ((ReactRootView) findViewById(R.id.react_root_view))
        .startReactApplication(mReactInstanceManager, "SecuritySetting", null);
  }
